        ...
        ScrollView(.vertical,showsIndicators: false){
            VStack(alignment: .leading, spacing: 10){
                ...
                PasswordInputFieldView(
                    ...
                    errorMessage: settingsViewModel.changePasswordErrors["currentPassword"] ?? "",
                ...
                PasswordInputFieldView(
                    ...
                    foregroundColor: Color.theme.onSurfaceColor,
                    errorMessage: settingsViewModel.changePasswordErrors["newPassword"] ?? "",
                    inputFieldStyle: .outlined,
                    onTextChange: { text in
                ...
                CustomButtonView(
                    ...
                    onTap: {
                        Task{
                            await settingsViewModel.chnagePassword(
                                onSuccess: {
